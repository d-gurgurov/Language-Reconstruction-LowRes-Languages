...
TYPE="500k"
OUT_DIR="data-bin/mt-en-safecheck-$TYPE"
mkdir -p $OUT_DIR
...
fairseq-train \
    ...
    --save-dir checkpoints/transformer_mt_en_safecheck_$TYPE \
    --log-format json \
    --log-interval 100 \
    --log-file checkpoints/transformer_mt_en_safecheck_$TYPE/log_mt_en.json \
