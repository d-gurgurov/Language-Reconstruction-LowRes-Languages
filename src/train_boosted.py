...
# data
first_half = pd.read_csv('/netscratch/dgurgurov/thesis/mt_lrls/results/tinystories_goodlrl_1.csv')
...
trainer.save_model('/netscratch/dgurgurov/thesis/mt_lrls/models/boosted/')
tokenizer.save_pretrained('/netscratch/dgurgurov/thesis/mt_lrls/models/boosted/')
