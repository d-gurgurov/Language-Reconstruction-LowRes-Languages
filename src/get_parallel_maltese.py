...
first_half.to_csv('/netscratch/dgurgurov/thesis/mt_lrls/results/first_half.csv', index=False)
second_half.to_csv('/netscratch/dgurgurov/thesis/mt_lrls/results/second_half.csv', index=False)
